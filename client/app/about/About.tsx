  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">EduMatrixAI?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than EduMatrixAI, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of EduMatrixAI, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created EduMatrixAI &ndash; to provide new programmers
          ...
          <br />
          <br />
          At EduMatrixAI, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But EduMatrixAI is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With EduMatrixAI by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the EduMatrixAI family today and let&apos;s
